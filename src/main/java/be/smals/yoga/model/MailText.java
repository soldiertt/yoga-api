...
public interface MailText {
    ...
    String BODY_USER_HAS_CARD_VALIDATED = """
                    <p>Bonjour,</p>
                    <p>Nous venons de valider votre carte d'abonnement %s séances à YogaEnPevele.fr<p>
                    <p>Vous pouvez désormais profiter de %s séances à réserver en ligne dans la zone "Abonnement".</p>
                    <p>Yoga En Pévèle - <a href="https://www.yogaenpevele.fr">https://www.yogaenpevele.fr</a></p>
                    """;
    String BODY_USER_CARD_REQUEST = """
            <p>Bonjour,</p>
            <p>Nous avons bien reçu votre demande de carte pour un abonnement %s séances.<br/>
